...
export function Footer() {
  const socialLinks = [
    { icon: Instagram, href: 'https://instagram.com/trueaesthetic', label: 'Instagram' },
    { icon: Facebook, href: 'https://facebook.com/trueaesthetic', label: 'Facebook' },
    { icon: Youtube, href: 'https://youtube.com/@trueaesthetic', label: 'YouTube' }
  ];

  const navLinks = [
    { title: 'Treatments', id: 'treatments' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <button
              ...
              className="text-3xl font-light mb-4 block text-left hover:opacity-80 transition-opacity"
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm text-gray-400">
              <a
                href="https://maps.google.com/?q=123+Aesthetic+Lane+Beverly+Hills+CA+90210"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            {/* Book CTA inside footer */}
            <motion.button
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.97 }}
              onClick={() => scrollToSection('contact')}
              className="mt-8 w-full px-5 py-3 bg-[#C6A87D] text-white rounded-full uppercase tracking-wider text-xs hover:bg-[#b89770] transition-colors duration-300"
            >
              Book Now
            </motion.button>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          ...
          <div className="flex gap-6">
            <a
              href="mailto:hello@trueaesthetic.com?subject=Privacy%20Policy%20Enquiry"
              className="hover:text-[#C6A87D] transition-colors"
            >
              Privacy Policy
            </a>
            <a
              href="mailto:hello@trueaesthetic.com?subject=Terms%20of%20Service%20Enquiry"
              className="hover:text-[#C6A87D] transition-colors"
            >
              Terms of Service
            </a>
